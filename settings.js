...
global.owner = process.env.OWNER_NUMBER  || '2349036687873' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=vMkngaBC#AzCfIgi8cU7SoYFZP7vICkDXI_7JfQq5v1HPqXPnS8Q ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "2349036687873" : process.env.MODERATORS ,    
